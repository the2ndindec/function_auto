...
class VioAddScreen(BasePage):
    ...
    def collect_detail_of_vio_from_db(self, vio_date, vio_address, vio_unit, vio_desc):
        ...
        tmp_detail = conn.get_infos(sql_constants.detail_of_vio(vio_date, vio_address, vio_unit, vio_desc))[0]  # 通过查询得到详情内容
    ...
    def choose_and_click_vio(self, vio_date, vio_address, vio_unit, vio_desc):
        ...
        _vio_elements = self.driver.get_elements('xpath', _vio_xpath_loc)  # 查询列表中的三违
